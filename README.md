...
Although you can use pixels to place and position everything, we provide a ["Character Grid"](docs/Character Grid.md) to help make window layout easier, and to make programming more akin to the text-mode development common on computers of the 1980s.
